...
class Business extends Model
{
    ...
    {
        $values = [
            'keyword' => isset($get['name']) ? $get['name'] : '',
            'country' => isset($get['country']) ? $get['country'] : 'Philippines',
            'industry' => isset($get['industry']) ? $get['industry'] : '',
            'time_open' => isset($get['time_open']) ? $get['time_open'] : null,
            'timezone' => isset($get['user_timezone']) ? $get['user_timezone'] : 'Asia/Manila',
